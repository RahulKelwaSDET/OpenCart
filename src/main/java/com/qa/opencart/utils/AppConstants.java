...
public class AppConstants {
	...
	public static final int SHORT_DEFAULT_VALUE = 5;
	public static final int MEDIUM_DEFAULT_VALUE = 10;
	public static final int LONG_DEFAULT_VALUE = 15;

	public static final List<String> EXP_HEADER_LIST = Arrays.asList("My Account", "My Orders", "My Affiliate Account",
			"Newsletter");
