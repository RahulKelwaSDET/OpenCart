...
public class RegisterPageTest extends BaseTest{
	...
	public String getRandomEmailID() {
		return "testmail"+UUID.randomUUID()+"@gmail.com";
...
//	}
	...
	public Object[][] getRegExcelTestData() {
		Object regData[][] = ExelUtil.getTestData(AppConstants.REGISTER_SHEET_NAME);
		return regData;
	}
	
	
	@Test(dataProvider = "regExcelData", invocationCount = 3)
